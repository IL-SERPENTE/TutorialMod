...
public class TutorialModClassTransformer implements IClassTransformer
{
	...
	private byte[] patchBlockFalling(String name, byte[] basicClass, boolean obf) {
		...
		insnList.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "fr/scarex/tutorialmod/core/event/TutorialModEventFactory", "onBlockFallingEvent", "(Lnet/minecraft/world/World;IIILnet/minecraft/block/Block;I)Z", false));
